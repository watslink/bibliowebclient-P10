 ...
 *         &lt;element name="nbTotalExemplaire" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class Book {
    ...
    protected int nbTotalExemplaire;
    ...
    /**
     * Obtient la valeur de la propri�t� nbTotalExemplaire.
     * 
     */
    public int getNbTotalExemplaire() {
        return nbTotalExemplaire;
    }

    /**
     * D�finit la valeur de la propri�t� nbTotalExemplaire.
     * 
     */
    public void setNbTotalExemplaire(int value) {
        this.nbTotalExemplaire = value;
    }
